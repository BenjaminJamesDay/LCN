...
# get data
trainvalid = data_loader_CIFAR100.get_train_valid_loader('./data', batch_size=batchsize, augment=True, random_seed=False)
trainloader, validloader = trainvalid

testloader = data_loader_CIFAR100.get_test_loader('./data', batch_size=batchsize)
